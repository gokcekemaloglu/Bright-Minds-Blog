...
import { Box, Typography, Container, Tabs, Tab, InputBase, IconButton, Menu, MenuItem, Pagination, Stack, Paper } from "@mui/material"
...
const MyBlogs = () => {
  ...
  const { singleUserBlogs: { data, details }, loading, stats } = useSelector((state) => state.blogs)
  ...
  useEffect(() => {
    ...
    getSingleUserBlogs({ params: options });
  }, [page, limit, search, currentUserId, activeTab, sortOption]);
